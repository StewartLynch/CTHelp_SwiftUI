...
WIthin your parent screen view, 
...
An sample function is as follows creates 5 help cards
...
This is easy to do as as all you need to do is add **.disabled(showCTHelp)** as a modifier to your button or in my case to the entire **navigationBarItems**
